...
document.querySelector("#save").addEventListener("click", () => {
  ...
  const clonedContent = cloneContainer.cloneNode(true);

  const elementsToRemove = clonedContent.querySelectorAll(`[taskid]`);
  elementsToRemove.forEach((element) => {
    element.parentNode.removeChild(element);
  });

  cloneContainer.parentNode.appendChild(clonedContent);
});
